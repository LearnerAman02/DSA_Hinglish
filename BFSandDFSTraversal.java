...
public class Main
{
    ...
    public static void bfs(ArrayList<Edge> graph[]){
        ...
        System.out.println("BFS khatam!!");
    }

  public static void dfs(ArrayList<Edge> graph[], int currNode, boolean[] visited) {
	...
	public static void main(String[] args) {
		...
		int[] currNode = new int[1];
		System.out.println("DFS Traversal : ");
		dfs(graph,0,visited);
		System.out.println("DFS Khatam!!");
	}
}
